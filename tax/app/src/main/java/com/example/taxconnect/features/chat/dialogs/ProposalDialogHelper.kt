...
class ProposalDialogHelper(
    ...
    fun showCreateProposalDialog(
        ...
        val dialog = MaterialAlertDialogBuilder(context)
            .setView(R.layout.dialog_create_proposal)
            .create()
        dialog.show()
        ...
        val etAdvanceAmount = dialog.findViewById<TextInputEditText>(R.id.etAdvanceAmount)
        val btnSendProposal = dialog.findViewById<View>(R.id.btnSendProposal)
