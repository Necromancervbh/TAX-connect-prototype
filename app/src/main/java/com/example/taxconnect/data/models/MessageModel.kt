...
data class MessageModel(
    ...
    var imageUrl: String? = null, // For image messages / PDF thumbnail
    var documentUrl: String? = null, // For document messages — the actual download/open URL
    ...
    // Upload Status ("UPLOADING", "FAILED", "SUCCESS")
